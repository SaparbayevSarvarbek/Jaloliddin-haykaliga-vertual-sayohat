...
import com.example.jaloliddinhaykaligavertualsayohat.databinding.FragmentAdminBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            monument.setOnClickListener {
                findNavController().navigate(R.id.monumentDataFragment)
            }
            person.setOnClickListener {
                findNavController().navigate(R.id.personDataFragment)
            }
