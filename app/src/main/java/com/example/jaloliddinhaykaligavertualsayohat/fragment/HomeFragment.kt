...
import com.example.jaloliddinhaykaligavertualsayohat.databinding.FragmentHomeBinding
...
private lateinit var binding:FragmentHomeBinding
       ...
       binding=FragmentHomeBinding.inflate(layoutInflater)
        ...
        binding.bottomNaviagtionView.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.virtual->replaceFragment(VirtualFragment())
                else -> {
                }
            }
            true
    ...
    fun replaceFragment(fragment: Fragment) {
        childFragmentManager.beginTransaction().replace(R.id.menu_layout,fragment).commit()
    }
